...
class SMBProjectManagerGUI:
    ...
    def create_projects_tab(self):
        ...
        project_list_scrollbar = ttk.Scrollbar(project_list_frame, orient="vertical", command=self.project_list.yview)
        ...
        create_project_button = ttk.Button(create_project_frame, text="Create", command=self.create_project)
    ...
    def create_tasks_tab(self):
        ...
        self.selected_project_label = ttk.Label(project_selection_frame, text="No project selected")
        ...
        task_list_scrollbar = ttk.Scrollbar(task_list_frame, orient="vertical", command=self.task_list.yview)
        ...
        create_task_button = ttk.Button(create_task_frame, text="Create", command=self.create_task)
    ...
    def create_reports_tab(self):
        ...
        self.completed_tasks_list.pack(side="left", padx=5, pady=5, fill="both", expand=True)

        completed_tasks_scrollbar = ttk.Scrollbar(completed_tasks_frame, orient="vertical", command=self.completed_tasks_list.yview)
        ...
        self.project_for_time_entry.pack(side="left", padx=5, pady=5, fill="x", expand=True)

        get_time_spent_button = ttk.Button(time_spent_frame, text="Get Time Spent", command=self.get_time_spent)
    ...
    def create_task(self):
        ...
        if selected_project:
            ...
            if task_name and assigned_to and deadline:
                self.manager.add_task(selected_project, task_name, assigned_to, deadline)
